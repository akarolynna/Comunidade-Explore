                ...
                <li>
                    <div class="grupo">
                        ...
                        <div class="dropdown-menu-left">
                            ...
                            <img alt=" Foto de usuário" src="<?php echo $_SESSION['usuario']['foto']  ?>" class="imagemUsuario dropdown-toggle" id="imgDropDown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
